...
public class ScreenMainActivity extends BaseActivity implements MainView,
    ...
    private final String bleType = "not connected";
    ...
    private void connectLogic(){
        ...
        Runnable runnable = () -> {
            connectShow();
            LogConMgrUtil.getInstance().i("connectShow");
        };
        connectShow();
    ...
    private void initCustomSketch(){
        ...
        activityMainBinding.customView.setIsOpenUndoAddStep(false);
        activityMainBinding.customView.setPaintWidth(30);
//        activityMainBinding.customView.setOpenOrCloseFlipPages(false);
    }
    ...
    public static Intent getCallingIntent(Context context){
        ...
        intent.setClass(context,ScreenMainActivity.class);
        return intent;
    }
    ...
    protected void initializeInjector() {
        DaggerMainComponent.builder()
                ...
                .build()
                .inject(ScreenMainActivity.this);
    ...
    public void onClick(@NotNull View view) {
        ...
        if (id == R.id.btn_connectDevice) {
            ...
            if (sendOrderCount % 2 == 0) {
                activityMainBinding.customView.setPaintType(TypesOfPensEnum.BallPen);
                activityMainBinding.lvLvBleData.setVisibility(View.GONE);
                activityMainBinding.relativeHide.setVisibility(View.VISIBLE);
            } else {
    ...
    protected void onResume() {
        ...
        activityMainBinding.customView.setPaintWidth(20);
    }
...
//            }
    ...
    public Context context(){
        return ScreenMainActivity.this;
    }
